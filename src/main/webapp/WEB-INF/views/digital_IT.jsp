                  ...
                  <div class="collapse navbar-collapse justify-content-center" id="navbarColor02">
                    <ul class="navbar-nav">
                      <li class="nav-item active">
                        <a class="nav-link" href="guide.html" data-abc="true">전체 <span class="visually-hidden">(current)</span></a>
                      </li>
                      <li class="nav-item">
