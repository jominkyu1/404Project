          ...
          <div class="accordion-item mb-3 border">
            <h2 class="h5 px-4 py-3 accordion-header d-flex justify-content-between align-items-center">
              <div class="form-check w-100 collapsed" data-bs-toggle="collapse" data-bs-target="#collapsePP"
                   aria-expanded="false">
                <input class="form-check-input" type="radio" name="payment" id="payment2" checked="checked">
...
<script>
    ...
    $('#proc_payment').click(function () {
        ...
        <c:choose>
          <c:when test="${!empty orderQuantity && !empty itemVO.item_id}">
            var orderQuantity = ${orderQuantity};
            var item_id = ${itemVO.item_id};
          </c:when>
          <c:otherwise>
            var orderQuantity = 0;
            var item_id = 0;
