				...
				<div class="col-4">
					<div class="text-center">
						<img src="https://placehold.it/300x300"
							class="rounded fixed-size-image" alt="sample">
					</div>
				</div>
				<div class="col-8">
					...
					<form:form modelAttribute="userRegisterForm" method="post">
							...
							<div class="alert alert-danger alert-dismissible fade show"
								...
								<c:forEach var="error" items="${errors.allErrors}">
									...
									<button type="button" class="btn-close" data-bs-dismiss="alert"
										aria-label="Close" style="border-radius: 5px;" /></button>
								...
								<tr>
									...
									<td>
										<div class="input-group"
											...
											<input style="white-space: nowrap;" type="hidden"
												name="idChanged" id="idChanged" value="false"> <input
												type="button" class="btn btn-outline-secondary mx-2"
									...
									<td>
										<div class="input-group"
											...
											<form:input path="password" type="password"
												cssClass="input-group-text" readonly="true" />
											<input style="white-space: nowrap;" type="hidden"
												name="passwordChanged" id="passwordChanged" value="false">
											<input type="button" class="btn btn-outline-secondary mx-2"
												value="비밀번호 변경" id="pwChangeBtn"
								...
								<tr>
									...
									<td>
										<div class="input-group"
											...
											<input style="white-space: nowrap;" type="button"
												class="btn btn-outline-secondary mx-2" value="주소찾기"
									...
									<td>
										<div class="input-group"
											...
											<form:input path="address_detail"
												cssClass="input-group-text w-50" />
										</div>
									</td>
								</tr>
								<tr>
						...
						<div class="d-flex justify-content-center mt-2 w-100">
							<input type="submit" class="btn btn-outline-secondary mx-2"
								value="수정완료"> <input type="button"
								class="btn btn-outline-secondary mx-2" value="취소"
